      ...
      <main className="bg-black min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <h1
              className="font-display font-black text-cream leading-none tracking-tight mb-4"
        ...
        <div className="border-b border-smoke">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4">
            <p className="font-display text-[11px] text-ash uppercase tracking-[0.2em]">
              {galleryData.images.length} Photos &middot; FIRE CAMP 2024 &middot; By @firecampgh
            </p>
          </div>
        </div>
        ...
        {/* CTA Strip */}
        <div
          className="mx-6 lg:mx-8 mb-16 rounded-2xl p-12 text-center"
